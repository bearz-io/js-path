...
import { CHAR_DOT } from "@bearz/chars/constants";
 ...
 * @example Usage
 * ```ts
 * import { extname } from "@bearz/path/posix/extname";
 ...
 * use the new version of `extname` from `@bearz/path/posix/unstable-extname`.
 *
